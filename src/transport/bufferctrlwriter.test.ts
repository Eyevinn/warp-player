...
describe('BufferCtrlWriter', () => {
  ...
  describe('SubscribeDone message', () => {
    ...
    it('should handle SubscribeDone without final values', () => {
      ...
      console.log('SubscribeDone without final values bytes:', bytesToHex(bytes));
  ...
  describe('ClientSetup message', () => {
    ...
    it('should handle ClientSetup with parameters', () => {
      ...
      const valueLength = testParam.value instanceof Uint8Array ? testParam.value.length : 1;
  ...
  describe('Buffer management', () => {
    it('should resize the buffer when needed', () => {
      ...
      const msg: Subscribe = {
        ...
        requestId: 42n,
        trackAlias: 1n,
        namespace: ['example', 'namespace', 'with', 'many', 'segments', 'to', 'force', 'buffer', 'resize'],
